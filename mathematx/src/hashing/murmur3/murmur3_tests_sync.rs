use super::murmur3_x32::{
    murmur3_x32, murmur3_x32_16byte_chunks, murmur3_x32_32byte_chunks, murmur3_x32_4byte_chunks,
    murmur3_x32_8byte_chunks,
};
use super::murmur3_x64::{
    murmur3_x64, murmur3_x64_16byte_chunks, murmur3_x64_32byte_chunks, murmur3_x64_64byte_chunks,
...
fn run_4byte_tests() {
    run_murmur3_hash_tests(
        ...
        murmur3_x64_8byte_chunks, // No 4-Byte processing for 64-bit
    );
}
