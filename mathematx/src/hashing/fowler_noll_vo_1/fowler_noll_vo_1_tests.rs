...
fn thread_safety_test() {
    let snapshots = load_snapshots("src/hashing/fowler_noll_vo_1/.snapshots/fowler_noll_vo_1_base_snap.json");
...
// TODO: Thread safety -> 4 Byte, 8 Byte, 16 Byte, 32 Byte, 64 Byte.